...
$PC = $env:computername
Write-HostCenter                                                                -BackgroundColor White
Write-HostCenter   "The following software is installed on: $PC"                -ForegroundColor Blue -BackgroundColor White
Write-HostCenter         "$web1"                                                -ForegroundColor Green -BackgroundColor White
Write-HostCenter                                                                -BackgroundColor White
}
