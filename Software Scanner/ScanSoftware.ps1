...
Write-Output '  The following software is installed on:' + "$PC"        ' -ForegroundColor Blue -BackgroundColor White
Write-Output '        "$web1"                                           ' -ForegroundColor Green -BackgroundColor White
Write-Host '                                                            ' -BackgroundColor White
}
